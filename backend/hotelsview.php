...
<?php echo $hotels->h_feature_image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<input type="checkbox" value="<?php echo $hotels->h_online_status->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $hotels->h_online_status->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<input type="checkbox" value="<?php echo $hotels->hotel_blocked->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $hotels->hotel_blocked->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
