...
$hotel_facilities_view = NULL; // Initialize page object first

class chotel_facilities_view extends chotel_facilities {
	...
	// Page object name
	var $PageObjName = 'hotel_facilities_view';
	...
	function __construct() {
		...
		if (@$_GET["hfacility_id"] <> "") {
			$this->RecKey["hfacility_id"] = $_GET["hfacility_id"];
			$KeyUrl .= "&amp;hfacility_id=" . urlencode($this->RecKey["hfacility_id"]);
		}
		if (@$_GET["hotel_id"] <> "") {
	...
	function Page_Init() {
		...
		if (@$_GET["hfacility_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["hfacility_id"]);
		}
		if (@$_GET["hotel_id"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["hfacility_id"] <> "") {
				$this->hfacility_id->setFormValue($_POST["hfacility_id"]);
				$this->RecKey["hfacility_id"] = $this->hfacility_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "hotel_facilitieslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "hotel_facilitieslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($hotel_facilities_view)) $hotel_facilities_view = new chotel_facilities_view();

// Page init
$hotel_facilities_view->Page_Init();

// Page main
$hotel_facilities_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$hotel_facilities_view->Page_Render();
?>
...
var CurrentForm = fhotel_facilitiesview = new ew_Form("fhotel_facilitiesview", "view");

// Form_CustomValidate event
fhotel_facilitiesview.Form_CustomValidate = 
...
fhotel_facilitiesview.ValidateRequired = true;
<?php } else { ?>
fhotel_facilitiesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fhotel_facilitiesview.Lists["x_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhotel_facilitiesview.Lists["x_status[]"].Options = <?php echo json_encode($hotel_facilities->status->Options()) ?>;
fhotel_facilitiesview.Lists["x_hot_facilities[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhotel_facilitiesview.Lists["x_hot_facilities[]"].Options = <?php echo json_encode($hotel_facilities->hot_facilities->Options()) ?>;
...
<?php if ($hotel_facilities->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$hotel_facilities_view->IsModal) { ?>
<?php if ($hotel_facilities->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $hotel_facilities_view->ExportOptions->Render("body") ?>
<?php
	foreach ($hotel_facilities_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$hotel_facilities_view->IsModal) { ?>
<?php if ($hotel_facilities->Export == "") { ?>
...
<?php } ?>
<?php $hotel_facilities_view->ShowPageHeader(); ?>
<?php
$hotel_facilities_view->ShowMessage();
?>
<?php if (!$hotel_facilities_view->IsModal) { ?>
<?php if ($hotel_facilities->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($hotel_facilities_view->Pager)) $hotel_facilities_view->Pager = new cPrevNextPager($hotel_facilities_view->StartRec, $hotel_facilities_view->DisplayRecs, $hotel_facilities_view->TotalRecs) ?>
<?php if ($hotel_facilities_view->Pager->RecordCount > 0 && $hotel_facilities_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($hotel_facilities_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $hotel_facilities_view->PageUrl() ?>start=<?php echo $hotel_facilities_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($hotel_facilities_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $hotel_facilities_view->PageUrl() ?>start=<?php echo $hotel_facilities_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $hotel_facilities_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($hotel_facilities_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $hotel_facilities_view->PageUrl() ?>start=<?php echo $hotel_facilities_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($hotel_facilities_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $hotel_facilities_view->PageUrl() ?>start=<?php echo $hotel_facilities_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $hotel_facilities_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fhotel_facilitiesview" id="fhotel_facilitiesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($hotel_facilities_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $hotel_facilities_view->Token ?>">
<?php } ?>
...
<?php if ($hotel_facilities->hfacility_id->Visible) { // hfacility_id ?>
	<tr id="r_hfacility_id">
		<td><span id="elh_hotel_facilities_hfacility_id"><?php echo $hotel_facilities->hfacility_id->FldCaption() ?></span></td>
...
<?php echo $hotel_facilities->hfacility_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_facilities->hotel_id->Visible) { // hotel_id ?>
	<tr id="r_hotel_id">
		<td><span id="elh_hotel_facilities_hotel_id"><?php echo $hotel_facilities->hotel_id->FldCaption() ?></span></td>
...
<?php echo $hotel_facilities->hotel_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_facilities->hf_name->Visible) { // hf_name ?>
	<tr id="r_hf_name">
		<td><span id="elh_hotel_facilities_hf_name"><?php echo $hotel_facilities->hf_name->FldCaption() ?></span></td>
...
<?php echo $hotel_facilities->hf_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_facilities->hf_image->Visible) { // hf_image ?>
	<tr id="r_hf_image">
		<td><span id="elh_hotel_facilities_hf_image"><?php echo $hotel_facilities->hf_image->FldCaption() ?></span></td>
...
<?php echo $hotel_facilities->hf_image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($hotel_facilities->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_hotel_facilities_status"><?php echo $hotel_facilities->status->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $hotel_facilities->status->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $hotel_facilities->status->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($hotel_facilities->hot_facilities->Visible) { // hot_facilities ?>
	<tr id="r_hot_facilities">
		<td><span id="elh_hotel_facilities_hot_facilities"><?php echo $hotel_facilities->hot_facilities->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $hotel_facilities->hot_facilities->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $hotel_facilities->hot_facilities->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($hotel_facilities->Export == "") { ?>
<script type="text/javascript">
fhotel_facilitiesview.Init();
</script>
<?php } ?>
<?php
$hotel_facilities_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($hotel_facilities->Export == "") { ?>
...
<?php
$hotel_facilities_view->Page_Terminate();
?>
