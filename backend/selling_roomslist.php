...
<?php if ($selling_rooms->day->Visible) { // day ?>
	...
	<?php } else { ?>
		<th data-name="day"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $selling_rooms->SortUrl($selling_rooms->day) ?>',1);"><div id="elh_selling_rooms_day" class="selling_rooms_day">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $selling_rooms->day->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($selling_rooms->day->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($selling_rooms->day->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($selling_rooms->month->Visible) { // month ?>
	...
	<?php } else { ?>
		<th data-name="month"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $selling_rooms->SortUrl($selling_rooms->month) ?>',1);"><div id="elh_selling_rooms_month" class="selling_rooms_month">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $selling_rooms->month->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($selling_rooms->month->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($selling_rooms->month->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($selling_rooms->year->Visible) { // year ?>
	...
	<?php } else { ?>
		<th data-name="year"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $selling_rooms->SortUrl($selling_rooms->year) ?>',1);"><div id="elh_selling_rooms_year" class="selling_rooms_year">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $selling_rooms->year->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($selling_rooms->year->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($selling_rooms->year->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
