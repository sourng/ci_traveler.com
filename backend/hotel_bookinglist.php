...
class chotel_booking_list extends chotel_booking {
	...
	function AdvancedSearchWhere($Default = FALSE) {
		global $Security;
		$sWhere = "";
		$this->BuildSearchSql($sWhere, $this->booking_id, $Default, FALSE); // booking_id
		...
		$this->BuildSearchSql($sWhere, $this->room_type, $Default, FALSE); // room_type
		$this->BuildSearchSql($sWhere, $this->max_adult, $Default, FALSE); // max_adult
		$this->BuildSearchSql($sWhere, $this->max_child, $Default, FALSE); // max_child
		$this->BuildSearchSql($sWhere, $this->cus_email, $Default, FALSE); // cus_email
		$this->BuildSearchSql($sWhere, $this->cus_passport, $Default, FALSE); // cus_passport
		$this->BuildSearchSql($sWhere, $this->cus_pickup, $Default, FALSE); // cus_pickup
		$this->BuildSearchSql($sWhere, $this->check_in, $Default, FALSE); // check_in
		$this->BuildSearchSql($sWhere, $this->check_out, $Default, FALSE); // check_out
		$this->BuildSearchSql($sWhere, $this->max_day_stay, $Default, FALSE); // max_day_stay
		$this->BuildSearchSql($sWhere, $this->total_amount, $Default, FALSE); // total_amount
		$this->BuildSearchSql($sWhere, $this->booking_status, $Default, TRUE); // booking_status
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->room_type->AdvancedSearch->Save(); // room_type
			$this->max_adult->AdvancedSearch->Save(); // max_adult
			$this->max_child->AdvancedSearch->Save(); // max_child
			$this->cus_email->AdvancedSearch->Save(); // cus_email
			$this->cus_passport->AdvancedSearch->Save(); // cus_passport
			$this->cus_pickup->AdvancedSearch->Save(); // cus_pickup
			$this->check_in->AdvancedSearch->Save(); // check_in
			$this->check_out->AdvancedSearch->Save(); // check_out
			$this->max_day_stay->AdvancedSearch->Save(); // max_day_stay
	...
	function CheckSearchParms() {
		...
		if ($this->customer_id->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->room_type->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->max_adult->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->max_child->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->cus_email->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->cus_passport->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->cus_pickup->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->check_in->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->check_out->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->max_day_stay->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->room_type->AdvancedSearch->UnsetSession();
		$this->max_adult->AdvancedSearch->UnsetSession();
		$this->max_child->AdvancedSearch->UnsetSession();
		$this->cus_email->AdvancedSearch->UnsetSession();
		$this->cus_passport->AdvancedSearch->UnsetSession();
		$this->cus_pickup->AdvancedSearch->UnsetSession();
		$this->check_in->AdvancedSearch->UnsetSession();
		$this->check_out->AdvancedSearch->UnsetSession();
		$this->max_day_stay->AdvancedSearch->UnsetSession();
	...
	function RestoreSearchParms() {
		...
		$this->room_type->AdvancedSearch->Load();
		$this->max_adult->AdvancedSearch->Load();
		$this->max_child->AdvancedSearch->Load();
		$this->cus_email->AdvancedSearch->Load();
		$this->cus_passport->AdvancedSearch->Load();
		$this->cus_pickup->AdvancedSearch->Load();
		$this->check_in->AdvancedSearch->Load();
		$this->check_out->AdvancedSearch->Load();
		$this->max_day_stay->AdvancedSearch->Load();
	...
	function LoadSearchValues() {
		...
		$this->booking_id->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_booking_id"]);
		if ($this->booking_id->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->booking_id->AdvancedSearch->SearchOperator = @$_GET["z_booking_id"];
		...
		// room_type
		$this->room_type->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_room_type"]);
		if ($this->room_type->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->room_type->AdvancedSearch->SearchOperator = @$_GET["z_room_type"];

		// max_adult
		$this->max_adult->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_max_adult"]);
		if ($this->max_adult->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->max_adult->AdvancedSearch->SearchOperator = @$_GET["z_max_adult"];

		// max_child
		$this->max_child->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_max_child"]);
		if ($this->max_child->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->max_child->AdvancedSearch->SearchOperator = @$_GET["z_max_child"];

		// cus_email
		$this->cus_email->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_cus_email"]);
		if ($this->cus_email->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->cus_email->AdvancedSearch->SearchOperator = @$_GET["z_cus_email"];

		// cus_passport
		$this->cus_passport->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_cus_passport"]);
		if ($this->cus_passport->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->cus_passport->AdvancedSearch->SearchOperator = @$_GET["z_cus_passport"];

		// cus_pickup
		$this->cus_pickup->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_cus_pickup"]);
		if ($this->cus_pickup->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->cus_pickup->AdvancedSearch->SearchOperator = @$_GET["z_cus_pickup"];

		// check_in
		$this->check_in->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_check_in"]);
		if ($this->check_in->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->check_in->AdvancedSearch->SearchOperator = @$_GET["z_check_in"];

		// check_out
		$this->check_out->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_check_out"]);
		if ($this->check_out->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->check_out->AdvancedSearch->SearchOperator = @$_GET["z_check_out"];

		// max_day_stay
		$this->max_day_stay->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_max_day_stay"]);
		if ($this->max_day_stay->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->max_day_stay->AdvancedSearch->SearchOperator = @$_GET["z_max_day_stay"];
		...
		// booking_status
		$this->booking_status->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_booking_status"]);
		if ($this->booking_status->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->booking_status->AdvancedSearch->SearchOperator = @$_GET["z_booking_status"];
		if (is_array($this->booking_status->AdvancedSearch->SearchValue)) $this->booking_status->AdvancedSearch->SearchValue = implode(",", $this->booking_status->AdvancedSearch->SearchValue);
		if (is_array($this->booking_status->AdvancedSearch->SearchValue2)) $this->booking_status->AdvancedSearch->SearchValue2 = implode(",", $this->booking_status->AdvancedSearch->SearchValue2);
	...
	function RenderRow() {
		...
		// booking_status
		if (strval($this->booking_status->CurrentValue) <> "") {
			$this->booking_status->ViewValue = "";
			$arwrk = explode(",", strval($this->booking_status->CurrentValue));
			$cnt = count($arwrk);
			for ($ari = 0; $ari < $cnt; $ari++) {
				$this->booking_status->ViewValue .= $this->booking_status->OptionCaption(trim($arwrk[$ari]));
				if ($ari < $cnt-1) $this->booking_status->ViewValue .= ew_ViewOptionSeparator($ari);
			}
		} else {
			$this->booking_status->ViewValue = NULL;
		}
		$this->booking_status->ViewCustomAttributes = "";
			...
			$this->booking_id->EditValue = ew_HtmlEncode($this->booking_id->AdvancedSearch->SearchValue);
			$this->booking_id->PlaceHolder = ew_RemoveHtml($this->booking_id->FldCaption());
			...
			$this->room_type->EditValue = ew_HtmlEncode($this->room_type->AdvancedSearch->SearchValue);
			...
			$this->max_adult->EditValue = ew_HtmlEncode($this->max_adult->AdvancedSearch->SearchValue);
			...
			$this->max_child->EditValue = ew_HtmlEncode($this->max_child->AdvancedSearch->SearchValue);
			...
			$this->cus_email->EditValue = ew_HtmlEncode($this->cus_email->AdvancedSearch->SearchValue);
			...
			$this->cus_passport->EditValue = ew_HtmlEncode($this->cus_passport->AdvancedSearch->SearchValue);
			...
			$this->cus_pickup->EditValue = ew_HtmlEncode($this->cus_pickup->AdvancedSearch->SearchValue);
			...
			$this->check_in->EditValue = ew_HtmlEncode(ew_FormatDateTime(ew_UnFormatDateTime($this->check_in->AdvancedSearch->SearchValue, 0), 8));
			...
			$this->check_out->EditValue = ew_HtmlEncode(ew_FormatDateTime(ew_UnFormatDateTime($this->check_out->AdvancedSearch->SearchValue, 0), 8));
			...
			$this->max_day_stay->EditValue = ew_HtmlEncode($this->max_day_stay->AdvancedSearch->SearchValue);
			...
			$this->booking_status->EditValue = $this->booking_status->Options(FALSE);
		}
	...
	function ExportQueryString() {
		...
		$this->AddSearchQueryString($sQry, $this->booking_id); // booking_id
		$this->AddSearchQueryString($sQry, $this->hroom_id); // hroom_id
		$this->AddSearchQueryString($sQry, $this->customer_id); // customer_id
		$this->AddSearchQueryString($sQry, $this->room_type); // room_type
		$this->AddSearchQueryString($sQry, $this->max_adult); // max_adult
		$this->AddSearchQueryString($sQry, $this->max_child); // max_child
		$this->AddSearchQueryString($sQry, $this->cus_email); // cus_email
		$this->AddSearchQueryString($sQry, $this->cus_passport); // cus_passport
		$this->AddSearchQueryString($sQry, $this->cus_pickup); // cus_pickup
		$this->AddSearchQueryString($sQry, $this->check_in); // check_in
		$this->AddSearchQueryString($sQry, $this->check_out); // check_out
		$this->AddSearchQueryString($sQry, $this->max_day_stay); // max_day_stay
		$this->AddSearchQueryString($sQry, $this->total_amount); // total_amount
		$this->AddSearchQueryString($sQry, $this->booking_status); // booking_status
...
fhotel_bookinglist.Lists["x_booking_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhotel_bookinglist.Lists["x_booking_status[]"].Options = <?php echo json_encode($hotel_booking->booking_status->Options()) ?>;

// Form object for search
var CurrentSearchForm = fhotel_bookinglistsrch = new ew_Form("fhotel_bookinglistsrch");

// Validate function for search
fhotel_bookinglistsrch.Validate = function(fobj) {
...
// Form_CustomValidate event
fhotel_bookinglistsrch.Form_CustomValidate = 
 function(fobj) { // DO NOT CHANGE THIS LINE!
...
// Use JavaScript validation or not
<?php if (EW_CLIENT_VALIDATE) { ?>
fhotel_bookinglistsrch.ValidateRequired = true; // Use JavaScript validation
<?php } else { ?>
fhotel_bookinglistsrch.ValidateRequired = false; // No JavaScript validation
<?php } ?>

// Dynamic selection lists
fhotel_bookinglistsrch.Lists["x_booking_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhotel_bookinglistsrch.Lists["x_booking_status[]"].Options = <?php echo json_encode($hotel_booking->booking_status->Options()) ?>;
</script>
<script type="text/javascript">
...
<?php
if ($gsSearchError == "")
	$hotel_booking_list->LoadAdvancedSearch(); // Load advanced search

// Render for search
$hotel_booking->RowType = EW_ROWTYPE_SEARCH;
...
<?php if ($hotel_booking->booking_status->Visible) { // booking_status ?>
	<div id="xsc_booking_status" class="ewCell form-group">
		<label class="ewSearchCaption ewLabel"><?php echo $hotel_booking->booking_status->FldCaption() ?></label>
		<span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_booking_status" id="z_booking_status" value="="></span>
		<span class="ewSearchField">
<div id="tp_x_booking_status" class="ewTemplate"><input type="checkbox" data-table="hotel_booking" data-field="x_booking_status" data-value-separator="<?php echo $hotel_booking->booking_status->DisplayValueSeparatorAttribute() ?>" name="x_booking_status[]" id="x_booking_status[]" value="{value}"<?php echo $hotel_booking->booking_status->EditAttributes() ?>></div>
<div id="dsl_x_booking_status" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $hotel_booking->booking_status->CheckBoxListHtml(FALSE, "x_booking_status[]") ?>
</div></div>
</span>
	</div>
<?php } ?>
