...
$destinations_edit = NULL; // Initialize page object first

class cdestinations_edit extends cdestinations {
	...
	function LoadFormValues() {
		...
		if (!$this->dest_landmark->FldIsDetailKey) {
			$this->dest_landmark->setFormValue($objForm->GetValue("x_dest_landmark"));
		}
	...
	function RestoreFormValues() {
		...
		$this->dest_landmark->CurrentValue = $this->dest_landmark->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// destinations
			$this->destinations->SetDbValueDef($rsnew, $this->destinations->CurrentValue, NULL, $this->destinations->ReadOnly);

			// dest_landmark
			$this->dest_landmark->SetDbValueDef($rsnew, $this->dest_landmark->CurrentValue, NULL, $this->dest_landmark->ReadOnly);

			// dest_description
			$this->dest_description->SetDbValueDef($rsnew, $this->dest_description->CurrentValue, NULL, $this->dest_description->ReadOnly);

			// dest_interest
			$this->dest_interest->SetDbValueDef($rsnew, $this->dest_interest->CurrentValue, NULL, $this->dest_interest->ReadOnly);

			// thing_todo
			$this->thing_todo->SetDbValueDef($rsnew, $this->thing_todo->CurrentValue, NULL, $this->thing_todo->ReadOnly);
...
// Create page object
if (!isset($destinations_edit)) $destinations_edit = new cdestinations_edit();
...
var CurrentForm = fdestinationsedit = new ew_Form("fdestinationsedit", "edit");

// Validate form
fdestinationsedit.Validate = function() {
...
fdestinationsedit.Form_CustomValidate = 
...
fdestinationsedit.ValidateRequired = true;
<?php } else { ?>
fdestinationsedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$destinations_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $destinations_edit->ShowPageHeader(); ?>
<?php
$destinations_edit->ShowMessage();
?>
<?php if (!$destinations_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($destinations_edit->Pager)) $destinations_edit->Pager = new cPrevNextPager($destinations_edit->StartRec, $destinations_edit->DisplayRecs, $destinations_edit->TotalRecs) ?>
<?php if ($destinations_edit->Pager->RecordCount > 0 && $destinations_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($destinations_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $destinations_edit->PageUrl() ?>start=<?php echo $destinations_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($destinations_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $destinations_edit->PageUrl() ?>start=<?php echo $destinations_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $destinations_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($destinations_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $destinations_edit->PageUrl() ?>start=<?php echo $destinations_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($destinations_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $destinations_edit->PageUrl() ?>start=<?php echo $destinations_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $destinations_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fdestinationsedit" id="fdestinationsedit" class="<?php echo $destinations_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($destinations_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $destinations_edit->Token ?>">
<?php } ?>
...
<?php if ($destinations->dest_id->Visible) { // dest_id ?>
	<div id="r_dest_id" class="form-group">
		<label id="elh_destinations_dest_id" class="col-sm-2 control-label ewLabel"><?php echo $destinations->dest_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $destinations->dest_id->CellAttributes() ?>>
<span id="el_destinations_dest_id">
<span<?php echo $destinations->dest_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $destinations->dest_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="destinations" data-field="x_dest_id" name="x_dest_id" id="x_dest_id" value="<?php echo ew_HtmlEncode($destinations->dest_id->CurrentValue) ?>">
<?php echo $destinations->dest_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($destinations->dest_landmark->Visible) { // dest_landmark ?>
	<div id="r_dest_landmark" class="form-group">
		<label id="elh_destinations_dest_landmark" for="x_dest_landmark" class="col-sm-2 control-label ewLabel"><?php echo $destinations->dest_landmark->FldCaption() ?></label>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $destinations_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($destinations_edit->Pager)) $destinations_edit->Pager = new cPrevNextPager($destinations_edit->StartRec, $destinations_edit->DisplayRecs, $destinations_edit->TotalRecs) ?>
<?php if ($destinations_edit->Pager->RecordCount > 0 && $destinations_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
fdestinationsedit.Init();
</script>
<?php
$destinations_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
