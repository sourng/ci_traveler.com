...
fhotel_bookingedit.Lists["x_booking_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhotel_bookingedit.Lists["x_booking_status[]"].Options = <?php echo json_encode($hotel_booking->booking_status->Options()) ?>;
...
<?php if ($hotel_booking->booking_status->Visible) { // booking_status ?>
	<div id="r_booking_status" class="form-group">
		<label id="elh_hotel_booking_booking_status" class="col-sm-2 control-label ewLabel"><?php echo $hotel_booking->booking_status->FldCaption() ?></label>
