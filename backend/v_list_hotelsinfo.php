...
class cv_list_hotels extends cTable {
	...
	function __construct() {
		...
		// star_rating
		$this->star_rating = new cField('v_list_hotels', 'v_list_hotels', 'x_star_rating', 'star_rating', '`star_rating`', '`star_rating`', 200, -1, FALSE, '`star_rating`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->star_rating->Sortable = TRUE; // Allow sort
		$this->star_rating->OptionCount = 6;
		$this->star_rating->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		...
		// hr_base_rate
		$this->hr_base_rate = new cField('v_list_hotels', 'v_list_hotels', 'x_hr_base_rate', 'hr_base_rate', '`hr_base_rate`', '`hr_base_rate`', 131, -1, FALSE, '`hr_base_rate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->star_rating->EditValue = $this->star_rating->Options(FALSE);
