...
class chotels_list extends chotels {
	...
	function LoadSearchValues() {
		...
		if (is_array($this->h_online_status->AdvancedSearch->SearchValue)) $this->h_online_status->AdvancedSearch->SearchValue = implode(",", $this->h_online_status->AdvancedSearch->SearchValue);
		if (is_array($this->h_online_status->AdvancedSearch->SearchValue2)) $this->h_online_status->AdvancedSearch->SearchValue2 = implode(",", $this->h_online_status->AdvancedSearch->SearchValue2);
		...
		if (is_array($this->hotel_blocked->AdvancedSearch->SearchValue)) $this->hotel_blocked->AdvancedSearch->SearchValue = implode(",", $this->hotel_blocked->AdvancedSearch->SearchValue);
		if (is_array($this->hotel_blocked->AdvancedSearch->SearchValue2)) $this->hotel_blocked->AdvancedSearch->SearchValue2 = implode(",", $this->hotel_blocked->AdvancedSearch->SearchValue2);
	}
	...
	function RenderRow() {
		...
		$this->hotel_blocked->ViewCustomAttributes = "";
			...
			$this->create_date->EditValue = ew_HtmlEncode(ew_FormatDateTime(ew_UnFormatDateTime($this->create_date->AdvancedSearch->SearchValue, 0), 8));
			...
			$this->update_date->EditValue = ew_HtmlEncode(ew_FormatDateTime(ew_UnFormatDateTime($this->update_date->AdvancedSearch->SearchValue, 0), 8));
	...
	function ExportQueryString() {
		...
		$this->AddSearchQueryString($sQry, $this->h_feature_image); // h_feature_image
...
<?php
$selwrk = (ew_ConvertToBool($hotels->h_online_status->AdvancedSearch->SearchValue)) ? " checked" : "";
?>
...
<?php if ($hotels->hotel_blocked->Visible) { // hotel_blocked ?>
	<div id="xsc_hotel_blocked" class="ewCell form-group">
		...
		<span class="ewSearchField">
<?php
$selwrk = (ew_ConvertToBool($hotels->hotel_blocked->AdvancedSearch->SearchValue)) ? " checked" : "";
?>
...
<span<?php echo $hotels->h_feature_image->ViewAttributes() ?>>
<?php echo $hotels->h_feature_image->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($hotels->h_address->Visible) { // h_address ?>
...
<?php if (ew_ConvertToBool($hotels->h_online_status->CurrentValue)) { ?>
<input type="checkbox" value="<?php echo $hotels->h_online_status->ListViewValue() ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $hotels->h_online_status->ListViewValue() ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if (ew_ConvertToBool($hotels->hotel_blocked->CurrentValue)) { ?>
<input type="checkbox" value="<?php echo $hotels->hotel_blocked->ListViewValue() ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $hotels->hotel_blocked->ListViewValue() ?>" disabled>
<?php } ?>
</span>
</span>
</td>
