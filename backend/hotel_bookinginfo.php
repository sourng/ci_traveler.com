...
class chotel_booking extends cTable {
	...
	function __construct() {
		...
		// booking_status
		$this->booking_status = new cField('hotel_booking', 'hotel_booking', 'x_booking_status', 'booking_status', '`booking_status`', '`booking_status`', 202, -1, FALSE, '`booking_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->booking_status->Sortable = TRUE; // Allow sort
		$this->booking_status->OptionCount = 3;
