...
class cdestinations extends cTable {
	...
	function __construct() {
		...
		// dest_landmark
		$this->dest_landmark = new cField('destinations', 'destinations', 'x_dest_landmark', 'dest_landmark', '`dest_landmark`', '`dest_landmark`', 200, -1, FALSE, '`dest_landmark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
