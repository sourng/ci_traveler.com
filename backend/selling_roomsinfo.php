...
class cselling_rooms extends cTable {
	...
	function __construct() {
		...
		// day
		$this->day = new cField('selling_rooms', 'selling_rooms', 'x_day', 'day', '`day`', '`day`', 3, -1, FALSE, '`day`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->day->Sortable = TRUE; // Allow sort
		$this->day->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['day'] = &$this->day;

		// month
		$this->month = new cField('selling_rooms', 'selling_rooms', 'x_month', 'month', '`month`', '`month`', 3, -1, FALSE, '`month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// year
		$this->year = new cField('selling_rooms', 'selling_rooms', 'x_year', 'year', '`year`', '`year`', 3, -1, FALSE, '`year`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
