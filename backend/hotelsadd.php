...
class chotels_add extends chotels {
	...
	function LoadDefaultValues() {
		...
		$this->h_feature_image->CurrentValue = NULL;
		$this->h_feature_image->OldValue = $this->h_feature_image->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// h_feature_image
		$this->h_feature_image->SetDbValueDef($rsnew, $this->h_feature_image->CurrentValue, NULL, FALSE);
		...
		// update_date
		$this->update_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->update_date->CurrentValue, 0), NULL, FALSE);

		// h_online_status
		$tmpBool = $this->h_online_status->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->h_online_status->SetDbValueDef($rsnew, $tmpBool, NULL, FALSE);

		// hotel_blocked
		$tmpBool = $this->hotel_blocked->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->hotel_blocked->SetDbValueDef($rsnew, $tmpBool, NULL, FALSE);
