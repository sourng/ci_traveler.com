...
fhotel_bookingview.Lists["x_booking_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhotel_bookingview.Lists["x_booking_status[]"].Options = <?php echo json_encode($hotel_booking->booking_status->Options()) ?>;
