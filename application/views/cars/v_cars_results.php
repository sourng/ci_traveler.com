                        ...
                        <li>
                            <a class="booking-item" href="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$67</span><span>/day</span>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Nissan GT R</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$72</span><span>/day</span>
                                        <p class="booking-item-flight-class">Premium</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Volvo V40</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$76</span><span>/day</span>
                                        <p class="booking-item-flight-class">Midsize</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Chevrolet Camaro</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$91</span><span>/day</span>
                                        <p class="booking-item-flight-class">Stabdart</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Toyota Prius Plus</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$82</span><span>/day</span>
                                        <p class="booking-item-flight-class">Compact</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a class="booking-item" href="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <ul class="booking-item-features booking-item-features-small clearfix">
                                                    <li rel="tooltip" data-placement="top" title="Climate Control"><i class="im im-climate-control"></i>
                                                    </li>
                                                    <li rel="tooltip" data-placement="top" title="Satellite Navigation"><i class="im im-satellite"></i>
                                                    </li>
                                                    <li rel="tooltip" data-placement="top" title="Stereo CD/MP3"><i class="im im-stereo"></i>
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$84</span><span>/day</span>
                        ...
                        <li>
                            <a class="booking-item" href="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$41</span><span>/day</span>
                                        <p class="booking-item-flight-class">Crossover</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">BMW X6</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$60</span><span>/day</span>
                                        <p class="booking-item-flight-class">Crossover</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a class="booking-item" href="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$32</span><span>/day</span>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Mitsubishi Outlander</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$33</span><span>/day</span>
                                        <p class="booking-item-flight-class">SUV</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Porsche Cayenne</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$34</span><span>/day</span>
                                        <p class="booking-item-flight-class">SUV</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Lamborghini Aventador</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Honda Civic</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$85</span><span>/day</span>
                                        <p class="booking-item-flight-class">Economy</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Mercedes Benz G</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$62</span><span>/day</span>
                                        <p class="booking-item-flight-class">Crossover</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="booking-item-car-img">
                                            ...
                                            <p class="booking-item-car-title">Audi S8</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3"><span class="booking-item-price">$87</span><span>/day</span>
                                        <p class="booking-item-flight-class">Fullsize</p><span class="btn btn-primary">Select</span>
                                    </div>
                                </div>
                            </a>
                        </li>
