...
class chotels extends cTable {
	...
	function __construct() {
		...
		// h_feature_image
		$this->h_feature_image = new cField('hotels', 'hotels', 'x_h_feature_image', 'h_feature_image', '`h_feature_image`', '`h_feature_image`', 200, -1, FALSE, '`h_feature_image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// create_date
		$this->create_date = new cField('hotels', 'hotels', 'x_create_date', 'create_date', '`create_date`', ew_CastDateFieldForLike('`create_date`', 0, "DB"), 135, 0, FALSE, '`create_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// update_date
		$this->update_date = new cField('hotels', 'hotels', 'x_update_date', 'update_date', '`update_date`', ew_CastDateFieldForLike('`update_date`', 0, "DB"), 135, 0, FALSE, '`update_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// h_online_status
		$this->h_online_status = new cField('hotels', 'hotels', 'x_h_online_status', 'h_online_status', '`h_online_status`', '`h_online_status`', 202, -1, FALSE, '`h_online_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// hotel_blocked
		$this->hotel_blocked = new cField('hotels', 'hotels', 'x_hotel_blocked', 'hotel_blocked', '`hotel_blocked`', '`hotel_blocked`', 202, -1, FALSE, '`hotel_blocked`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->update_date->EditValue = ew_FormatDateTime($this->update_date->CurrentValue, 8);
